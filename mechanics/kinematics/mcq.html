...
<head>
    ...
    <title>Assessment Quiz: 1D Kinematics - Physics Daily</title>
    <meta name="description" content="A comprehensive and customizable multiple-choice quiz on one-dimensional kinematics with a timer and detailed solutions.">
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Inter', sans-serif; line-height: 1.6; color: var(--text-primary); background-color: var(--bg-primary); transition: all 0.3s ease; }
        em { font-family: 'JetBrains Mono', monospace; font-style: italic; font-weight: 500; }
        .container { max-width: 1400px; margin: 0 auto; padding: 0 20px; }
        .nav { background: var(--card-bg); border-bottom: 1px solid var(--border-color); padding: 1rem 0; position: sticky; top: 0; z-index: 100; backdrop-filter: blur(10px); }
        .nav-content { display: flex; justify-content: space-between; align-items: center; }
        .nav-logo { font-size: 1.5rem; font-weight: 700; color: var(--primary-color); text-decoration: none; }
        .nav-links { display: none; list-style: none; gap: 2rem; } /* Hidden for mobile-first, shown in media query */
        .nav-links a { color: var(--text-secondary); text-decoration: none; font-weight: 500; transition: color 0.2s ease; }
        .nav-links a:hover { color: var(--primary-color); }
        .breadcrumb { background: var(--bg-secondary); padding: 1rem 0; border-bottom: 1px solid var(--border-color); }
        .breadcrumb a, .breadcrumb .separator { color: var(--text-secondary); text-decoration: none; }
        .breadcrumb a:hover { color: var(--primary-color); }
        .breadcrumb .current { color: var(--text-primary); font-weight: 500; }
        .separator { margin: 0 0.5rem; }
        .theme-toggle { position: fixed; top: 100px; right: 20px; z-index: 1000; background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 25px; padding: 4px; box-shadow: var(--shadow-md); display: flex; flex-direction: column; gap: 4px; }
        .theme-toggle button { background: none; border: none; padding: 10px; border-radius: 50%; cursor: pointer; font-size: 16px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; color: var(--text-secondary); }
        .theme-toggle button.active { background: var(--primary-color); color: white; }
        .header { background: var(--bg-secondary); padding: 2rem 0; border-bottom: 1px solid var(--border-color); }
        .header h1 { font-size: 2.5rem; color: var(--text-primary); }
        .header .subtitle { font-size: 1.25rem; color: var(--text-secondary); }
        
        .btn { background: var(--primary-color); color: white; border: none; padding: 12px 24px; border-radius: 8px; cursor: pointer; font-weight: 500; transition: all 0.2s ease; text-decoration: none; }
        .btn:hover { background: var(--primary-dark); transform: translateY(-1px); }
        .btn-secondary { background: var(--bg-tertiary); color: var(--text-primary); border: 1px solid var(--border-color); }
        .btn-secondary:hover { background: var(--border-hover); }

        .test-container { display: grid; grid-template-columns: 1fr; gap: 2rem; max-width: 1400px; margin: 2rem auto; }
        .test-main, .test-sidebar { background-color: var(--card-bg); border: 1px solid var(--border-color); border-radius: var(--border-radius); padding: 2rem; box-shadow: var(--shadow-sm); }
        ...
        .quiz-setup { display: flex; flex-direction: column; align-items: center; gap: 1rem; margin-top: 1.5rem; }
        .setup-item { display: flex; align-items: center; gap: 0.5rem; }
        .setup-item label { font-weight: 600; }
        .setup-item input, .setup-item select { padding: 0.5rem; border-radius: 6px; border: 1px solid var(--border-color); background: var(--bg-secondary); color: var(--text-primary); }
        .setup-item input { width: 80px; text-align: center; }
        ...
        .question-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 1px solid var(--border-color); }
        ...
        .option-item label { display: flex; align-items: center; padding: 1rem; background-color: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 8px; cursor: pointer; transition: var(--transition); }
        ...
        .quiz-navigation { display: flex; justify-content: space-between; align-items: center; margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid var(--border-color); }

        .sidebar-header { text-align: center; margin-bottom: 1rem; font-weight: 600; }
        .question-palette { display: grid; grid-template-columns: repeat(auto-fill, minmax(40px, 1fr)); gap: 0.5rem; margin-bottom: 1rem; }
        .palette-btn { width: 40px; height: 40px; border: 1px solid var(--border-color); background-color: var(--bg-secondary); color: var(--text-secondary); border-radius: 6px; cursor: pointer; transition: var(--transition); font-weight: 500; }
        .palette-btn:hover { background-color: var(--border-hover); }
        .palette-btn.current { border-color: var(--primary-color); background-color: var(--primary-light); color: var(--primary-dark); font-weight: bold; }
        ...
        @media (min-width: 1024px) {
            .test-container { grid-template-columns: 3fr 1fr; }
            .test-sidebar { position: sticky; top: 100px; max-height: calc(100vh - 120px); overflow-y: auto; }
        }
    </style>
</head>
<body>
    ...
    <div class="breadcrumb">
        <div class="container">
            <nav aria-label="Breadcrumb">
                ...
                <span class="separator">›</span>
                <a href="index.html">🚀 One-Dimensional Kinematics</a>
                <span class="separator">›</span>
    ...
    <main>
        <div id="instructions-container" class="instructions-container">
            <header class="header">
                <div class="container">
                    <h1>Chapter 2: Assessment Quiz</h1>
                    <p class="subtitle">Test your mastery of One-Dimensional Kinematics</p>
                </div>
            </header>
            <h2>📝 Instructions</h2>
            <ul>
                <li>This test contains up to <strong>100 multiple-choice questions</strong>.</li>
            ...
            <div class="quiz-setup">
                 <div class="setup-item">
                    ...
                    <select id="question-count-select">
                        ...
                        <option value="100" selected>100 (Full Chapter)</option>
                    </select>
                </div>
                <div class="setup-item">
