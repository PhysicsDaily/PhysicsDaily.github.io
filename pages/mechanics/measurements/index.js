        ...
        <div className="container">
          ...
          <div className={styles.section}>
            ...
            <div className={styles.exampleBox}>
              ...
              <p>q(t) = q₀ <span className="equation">e^{'-t/RC'}</span>. Exponent must be dimensionless ⇒ [RC] = [T].</p>
            </div>
            <div className={styles.exampleBox}>
          ...
          <div className={styles.section}>
            ...
            <ul>
              ...
              <li>Exponential y = A <span className="equation">e^{kx}</span> ⇒ ln y = ln A + kx (semi-log plot).</li>
            </ul>
