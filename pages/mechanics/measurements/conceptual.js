...
const questions = [
  ...
  { id: 19, difficulty: 'Hard', question: 'A planet moves around the sun in a circular orbit of radius $r$. The time period $T$ depends on the radius $r$, the mass of the sun $M$, and the gravitational constant $G$. Show dimensionally that $T^2 \\propto r^3$.', answer: '<p>Let $T = k \\cdot r^a M^b G^c$. Dimensions: $T=[T]$, $r=[L]$, $M=[M]$, $G=[M^{-1}L^3T^{-2}]$.<br>$[T] = [L]^a [M]^b [M^{-1}L^3T^{-2}]^c = [M^{b-c} L^{a+3c} T^{-2c}]$.<br>Equating powers:<br>For T: $1=-2c \\Rightarrow c=-1/2$.<br>For M: $b-c=0 \\Rightarrow b=c=-1/2$.<br>For L: $a+3c=0 \\Rightarrow a=-3c = -3(-1/2) = 3/2$.<br>So, $T = k \\cdot r^{3/2} M^{-1/2} G^{-1/2}$. Squaring both sides gives $T^2 = k^2 \\frac{r^3}{MG}$, which shows $T^2 \\propto r^3$.</p>' },
