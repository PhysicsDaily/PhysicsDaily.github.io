...
import useScrollAnimation from '../hooks/useScrollAnimation'; // Re-enabled the animation hook
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Comprehensive physics notes and study resources covering mechanics, thermodynamics, electromagnetism, optics, and modern physics. Interactive learning for advanced physics concepts." />
      </Head>
              ...
              <section key={section.id} id={section.id} className={`${styles.section} fade-in`}>
                ...
                <div className={styles.topicGrid}>
                    {section.cards.map((card) => (
                        <TopicCard key={card.title} cardData={card} type={section.card_type} />
                    ))}
                </div>
              </section>
            ))}
